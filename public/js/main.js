...
var map = L.map('map', {
	minZoom: 6,
	maxZoom: 19
}).setView([36.9644354,127.7088928+3.5], 7);
...
var hospital = [
	...
	{name: '송태의 내과', num: 0, lat: 37.503721, lon: 127.089854, icon: 'songtaeui', y: 0},
	{name: '건국대병원', num: 0, lat: 37.540958, lon: 127.079305, icon: 'gunguk', y: 0},
	{name: '평택굿모닝병원', num: 0, lat: 36.990843, lon: 127.12025, icon: 'goodmorning', y: 0},
	{name: '강동 경희대학교의대병원', num: 0, lat: 37.553714, lon: 127.157663, icon: 'kangdong', y: 0}
];
